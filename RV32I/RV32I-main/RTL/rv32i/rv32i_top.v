module rv32i_top(
    ...
    wire        MemRead, MemToReg, MemWrite, Branch, Jump, ALUSrc1, ALUSrc2, LUI, RegWrite;
    wire        ZERO;
    ...
    assign Stall =          hazard_stall || (cpu_valid && !bus_ready);
    ...
    assign cpu_addr      =  EX_MEM_ALU_result;
    assign cpu_wdata     =  EX_MEM_rv2;
    assign cpu_write_req =  EX_MEM_Mem_Write;
